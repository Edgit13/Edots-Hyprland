...
ShellRoot {
    ...
    IpcHandler {
        ...
        function showMixer(): void { root.openSurface("system") }
        function toggleMixer(): void { root.toggleSurface("system") }
        ...
        PanelWindow {
            ...
            Rectangle {
                ...
                RowLayout {
                    ...
                    Text {
                        ...
                        MouseArea {
                            ...
                            anchors.margins: -4
                            cursorShape: Qt.PointingHandCursor
                            onClicked: root.activeSurface = "system"
                        }
                    }
                ...
                Rectangle {
                    anchors.fill: parent
                    anchors.margins: 14
                    visible: root.activeSurface === "system"
                    opacity: visible ? 1 : 0
                    radius: 18
                    color: Qt.rgba(Colors.bg2.r, Colors.bg2.g, Colors.bg2.b, 0.65)
                    border.width: 1
                    ...
                    ColumnLayout {
                        ...
                        Text {
                            ...
                            text: "Audio controls are disabled in the MangoWM fork minimal mode to avoid PipeWire runtime issues."
                            color: Colors.grey2
