...
Item {
    ...
    readonly property string configDir: Quickshell.env("HOME") + "/.config/quickshell-mangowm"
    ...
    Process {
        id: reloadShellProc
        command: ["sh", "-c", "pkill -f 'qs .*quickshell-mangowm/bar/shell.qml' 2>/dev/null || true; qs -p \"$HOME/.config/quickshell-mangowm/bar\" >/dev/null 2>&1 &"]
    }
    ...
    Process {
        id: gameModeProc
        command: [Quickshell.env("HOME") + "/.config/quickshell-mangowm/scripts/gamemode.sh"]
        running: false
    }
        ...
        Flickable {
            ...
            ColumnLayout {
                ...
                ColumnLayout {
                    ...
                    InfoRow { title: "Super + X"; detail: "Suggested: open mixer" }
